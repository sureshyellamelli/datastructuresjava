...
public class CollectionExamples extends Thread {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(calculateValue(pp, ch));

    }

    private static String calculateValue(float price, float cash) {
